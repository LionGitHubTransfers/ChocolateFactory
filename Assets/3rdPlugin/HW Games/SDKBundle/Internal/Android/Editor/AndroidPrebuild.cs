...
namespace HWGames.Bundles.Internal.Editor
{
    ...
    {
        private const string SourceFolderPath = "3rdPlugin/HW Games/SDKBundle/Internal/Android/Editor";
        ...
        private static void PrepareResolver()
        {
            ...
            GooglePlayServices.PlayServicesResolver.Resolve(ReplaceMaven, true);
        }

        private static void ReplaceMaven() {
            string sourcePath = Path.Combine(Application.dataPath, DestGradlePath);
            string content = File.ReadAllText(sourcePath)
                                 .Replace("url \"https://maven.google.com\"", "url 'https://maven.aliyun.com/repository/google'");
