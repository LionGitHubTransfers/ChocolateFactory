...
namespace HWGames.Bundles.Internal.Analytics
{
    ...
    {
        private const string GameCountPrefKey = "HWBundle_GameCount";
        private const string SuccessfulGameCountPrefKey = "HWBundle_SuccessfulGameCount";
        private const string LevelPrefKey = "HWBundle_Level";
        private const string LaunchCountPrefKey = "HWBundle_AppLaunchCount";
        private const string HighestScorePrefKey = "HWBundle_HighScore";
        private const string FSShownCountPrefKey = "HWBundle_FSShownCount";
        private const string RVShownCountPrefKey = "HWBundle_RVShownCount";
