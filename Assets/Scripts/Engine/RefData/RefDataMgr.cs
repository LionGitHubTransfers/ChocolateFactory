...
public class RefDataMgr : BaseRefDataMgr<RefDataMgr> {
    ...
    public void InitBasic () {
        ...
        //LoadGeneric(RefLanguage.language);
        //LoadGeneric(RefDownloadTip.downloadtip);
        //LoadGeneric(RefAssetbundle.assetbundle);
        //LoadGeneric(RefPlatformZone.platformZoneMap);
    }
}
